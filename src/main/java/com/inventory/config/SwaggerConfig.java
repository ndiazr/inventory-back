...
{
    /**
     * Mathod that made a swagger configuration.
     *
     * @return An ApiSelectorBuilder, which provides the apis() and paths() methods to filter the
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .apiInfo(metaData())
            .tags(
                new Tag("example-controller", "API REST of Example")
            );
    }
